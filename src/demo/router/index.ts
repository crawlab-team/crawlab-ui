...
export const initDemoRoutes = () => {
      ...
      children: [
        {
          ...
          children: [
            {
              path: '/demo/nav/sidebar/list',
              title: 'Sidebar List',
              icon: ['fa', 'list'],
            },
            {
              path: '/demo/nav/sidebar/tree',
              title: 'Sidebar Tree',
              icon: ['fa', 'folder-tree'],
            },
          ],
  ...
  store.commit('layout/setMenuItems', [...layoutState.menuItems, ...menuItems]);
};
