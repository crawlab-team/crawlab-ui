...
// git ref type
const gitRefType = computed<string>(() => 'branch');
...
// all table data
const allTableData = computed<TableData<GitRef>>(() => state.gitBranches);
...
watch(() => activeId.value, () => store.dispatch(`${ns}/getGitBranches`, {id: activeId.value}));
onBeforeMount(() => store.dispatch(`${ns}/getGitBranches`, {id: activeId.value}));
</script>
