...
import { type ElementNode, type LexicalEditor, LexicalNode, TextNode } from 'lexical';
...
export declare function findFirstMatch(text: string, matchers: Array<LinkMatcher>): LinkMatcherResult | null;
...
export declare function isContentAroundIsValid(matchStart: number, matchEnd: number, text: string, node: TextNode): boolean;
export declare function handleLinkCreation(node: TextNode, matchers: Array<LinkMatcher>, onChange: ChangeHandler): void;
export declare function handleLinkEdit(linkNode: AutoLinkNode, matchers: Array<LinkMatcher>, onChange: ChangeHandler): void;
export declare function handleBadNeighbors(textNode: TextNode, onChange: ChangeHandler): void;
export declare function replaceWithChildren(node: ElementNode): Array<LexicalNode>;
